...
class $CatalogItemsTable extends CatalogItems
  ...
  List<GeneratedColumn> get $columns =>
      [id, globalId, name, displayName, categoryId, isUserAdded, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class $ShoppingListsTable extends ShoppingLists
  ...
  static const VerificationMeta _modifiedByDeviceMeta =
      const VerificationMeta('modifiedByDevice');
  @override
  late final GeneratedColumn<String> modifiedByDevice = GeneratedColumn<String>(
      'modified_by_device', aliasedName, true,
  ...
  late final GeneratedColumn<bool> syncEnabled = GeneratedColumn<bool>(
      ...
      defaultValue: const Constant(false));
  static const VerificationMeta _syncSpaceIdMeta =
      const VerificationMeta('syncSpaceId');
  @override
  late final GeneratedColumn<String> syncSpaceId = GeneratedColumn<String>(
      'sync_space_id', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  ...
  VerificationContext validateIntegrity(Insertable<ShoppingList> instance,
    ...
    if (data.containsKey('modified_by_device')) {
      context.handle(
          ...
          modifiedByDevice.isAcceptableOrUnknown(
              data['modified_by_device']!, _modifiedByDeviceMeta));
    }
    ...
    if (data.containsKey('sync_space_id')) {
      context.handle(
          _syncSpaceIdMeta,
          syncSpaceId.isAcceptableOrUnknown(
              data['sync_space_id']!, _syncSpaceIdMeta));
    }
  ...
  ShoppingList map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ShoppingList(
      ...
      modifiedByDevice: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}modified_by_device']),
      syncEnabled: attachedDatabase.typeMapping
          .read(DriftSqlType.bool, data['${effectivePrefix}sync_enabled'])!,
      syncSpaceId: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}sync_space_id']),
...
class ShoppingList extends DataClass implements Insertable<ShoppingList> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || modifiedByDevice != null) {
      map['modified_by_device'] = Variable<String>(modifiedByDevice);
    }
    map['sync_enabled'] = Variable<bool>(syncEnabled);
    if (!nullToAbsent || syncSpaceId != null) {
      map['sync_space_id'] = Variable<String>(syncSpaceId);
    }
  ...
  ShoppingListsCompanion toCompanion(bool nullToAbsent) {
    return ShoppingListsCompanion(
      ...
      deletedAt: deletedAt == null && nullToAbsent
          ? const Value.absent()
          : Value(deletedAt),
      modifiedByDevice: modifiedByDevice == null && nullToAbsent
          ? const Value.absent()
          : Value(modifiedByDevice),
      syncEnabled: Value(syncEnabled),
      syncSpaceId: syncSpaceId == null && nullToAbsent
          ? const Value.absent()
          : Value(syncSpaceId),
  ...
  factory ShoppingList.fromJson(Map<String, dynamic> json,
    ...
    return ShoppingList(
      ...
      syncSpaceId: serializer.fromJson<String?>(json['syncSpaceId']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'syncSpaceId': serializer.toJson<String?>(syncSpaceId),
  ...
  ShoppingList copyWith(
          ...
          bool? syncEnabled,
          Value<String?> syncSpaceId = const Value.absent(),
      ...
      ShoppingList(
        ...
        modifiedByDevice: modifiedByDevice.present
            ? modifiedByDevice.value
            : this.modifiedByDevice,
        syncEnabled: syncEnabled ?? this.syncEnabled,
        syncSpaceId: syncSpaceId.present ? syncSpaceId.value : this.syncSpaceId,
        lastCheckOffAt:
  ...
  ShoppingList copyWithCompanion(ShoppingListsCompanion data) {
    return ShoppingList(
      ...
      syncSpaceId:
          data.syncSpaceId.present ? data.syncSpaceId.value : this.syncSpaceId,
  ...
  bool operator ==(Object other) =>
      ...
      (other is ShoppingList &&
          ...
          other.syncSpaceId == this.syncSpaceId &&
...
class ShoppingListsCompanion extends UpdateCompanion<ShoppingList> {
  ...
  final Value<String?> syncSpaceId;
  ...
  const ShoppingListsCompanion({
    ...
    this.syncSpaceId = const Value.absent(),
  ...
  static Insertable<ShoppingList> custom({
    ...
    return RawValuesInsertable({
      ...
      if (syncSpaceId != null) 'sync_space_id': syncSpaceId,
  ...
  ShoppingListsCompanion copyWith(
    ...
    return ShoppingListsCompanion(
      ...
      syncEnabled: syncEnabled ?? this.syncEnabled,
      syncSpaceId: syncSpaceId ?? this.syncSpaceId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (syncSpaceId.present) {
      map['sync_space_id'] = Variable<String>(syncSpaceId.value);
    }
...
class $MealsTable extends Meals with TableInfo<$MealsTable, Meal> {
  ...
  late final GeneratedColumn<DateTime> createdAt = GeneratedColumn<DateTime>(
      'created_at', aliasedName, false,
      type: DriftSqlType.dateTime, requiredDuringInsert: true);
  static const VerificationMeta _viewScaleFactorMeta =
      const VerificationMeta('viewScaleFactor');
  @override
  late final GeneratedColumn<double> viewScaleFactor = GeneratedColumn<double>(
      'view_scale_factor', aliasedName, false,
      type: DriftSqlType.double,
      requiredDuringInsert: false,
      defaultValue: const Constant(1.0));
  ...
  VerificationContext validateIntegrity(Insertable<Meal> instance,
    ...
    if (data.containsKey('view_scale_factor')) {
      context.handle(
          _viewScaleFactorMeta,
...
class $ReceiptListsTable extends ReceiptLists
    with TableInfo<$ReceiptListsTable, ReceiptList> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ReceiptListsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'receipt_lists';
  @override
  VerificationContext validateIntegrity(Insertable<ReceiptList> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ReceiptList map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ReceiptList(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
  ...
  @override
  $ReceiptListsTable createAlias(String alias) {
    return $ReceiptListsTable(attachedDatabase, alias);
  }
}

class ReceiptList extends DataClass implements Insertable<ReceiptList> {
  final int id;
  final String name;
  final DateTime createdAt;
  final DateTime updatedAt;
  ...
  ReceiptListsCompanion toCompanion(bool nullToAbsent) {
  ...
  factory ReceiptList.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return ReceiptList(
      id: serializer.fromJson<int>(json['id']),
  ...
  @override
  String toString() {
    return (StringBuffer('ReceiptList(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt')
...
class ReceiptListsCompanion extends UpdateCompanion<ReceiptList> {
  ...
  ReceiptListsCompanion.insert({
    ...
    required DateTime updatedAt,
        ...
        createdAt = Value(createdAt),
        updatedAt = Value(updatedAt);
  static Insertable<ReceiptList> custom({
    Expression<int>? id,
    Expression<String>? name,
    Expression<DateTime>? createdAt,
    Expression<DateTime>? updatedAt,
  ...
  ReceiptListsCompanion copyWith(
      {Value<int>? id,
      Value<String>? name,
      Value<DateTime>? createdAt,
      Value<DateTime>? updatedAt}) {
  ...
  @override
  String toString() {
    return (StringBuffer('ReceiptListsCompanion(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt')
...
class $ReceiptsTable extends Receipts with TableInfo<$ReceiptsTable, Receipt> {
  ...
  late final GeneratedColumn<String> receiptNumber = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _pdfFileNameMeta =
      const VerificationMeta('pdfFileName');
  @override
  late final GeneratedColumn<String> pdfFileName = GeneratedColumn<String>(
      'pdf_file_name', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  static const VerificationMeta _currencyMeta =
      const VerificationMeta('currency');
  @override
  late final GeneratedColumn<String> currency = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string,
      requiredDuringInsert: false,
      defaultValue: const Constant('SEK'));
  static const VerificationMeta _createdAtMeta =
      const VerificationMeta('createdAt');
  @override
  late final GeneratedColumn<DateTime> createdAt = GeneratedColumn<DateTime>(
  ...
  VerificationContext validateIntegrity(Insertable<Receipt> instance,
    ...
    if (data.containsKey('pdf_file_name')) {
      context.handle(
          _pdfFileNameMeta,
          pdfFileName.isAcceptableOrUnknown(
              data['pdf_file_name']!, _pdfFileNameMeta));
    } else if (isInserting) {
  ...
  Receipt map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Receipt(
      ...
      pdfFileName: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}pdf_file_name'])!,
      currency: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}currency'])!,
      createdAt: attachedDatabase.typeMapping
          .read(DriftSqlType.dateTime, data['${effectivePrefix}created_at'])!,
...
class Receipt extends DataClass implements Insertable<Receipt> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['pdf_file_name'] = Variable<String>(pdfFileName);
    map['currency'] = Variable<String>(currency);
    map['created_at'] = Variable<DateTime>(createdAt);
    return map;
  }
  ...
  Receipt copyWithCompanion(ReceiptsCompanion data) {
    return Receipt(
      ...
      receiptNumber: data.receiptNumber.present
          ...
          : this.receiptNumber,
      pdfFileName:
          data.pdfFileName.present ? data.pdfFileName.value : this.pdfFileName,
      currency: data.currency.present ? data.currency.value : this.currency,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
    );
  }
  ...
  @override
  int get hashCode => Object.hash(id, listId, shopName, purchasedAt,
      totalAmount, receiptNumber, pdfFileName, currency, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Receipt &&
...
class ReceiptsCompanion extends UpdateCompanion<Receipt> {
  ...
  static Insertable<Receipt> custom({
    ...
    return RawValuesInsertable({
      ...
      if (pdfFileName != null) 'pdf_file_name': pdfFileName,
      if (currency != null) 'currency': currency,
      if (createdAt != null) 'created_at': createdAt,
    });
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (pdfFileName.present) {
      map['pdf_file_name'] = Variable<String>(pdfFileName.value);
    }
    if (currency.present) {
      map['currency'] = Variable<String>(currency.value);
    }
...
class $ReceiptLinesTable extends ReceiptLines
  ...
  late final GeneratedColumn<int> receiptId = GeneratedColumn<int>(
      ...
      type: DriftSqlType.int, requiredDuringInsert: true);
  static const VerificationMeta _originalDescriptionMeta =
      const VerificationMeta('originalDescription');
  @override
  late final GeneratedColumn<String> originalDescription =
      GeneratedColumn<String>('original_description', aliasedName, false,
          type: DriftSqlType.string, requiredDuringInsert: true);
  ...
  @override
  VerificationContext validateIntegrity(Insertable<ReceiptLine> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
    ...
    if (data.containsKey('original_description')) {
      context.handle(
          _originalDescriptionMeta,
          originalDescription.isAcceptableOrUnknown(
              data['original_description']!, _originalDescriptionMeta));
    } else if (isInserting) {
      context.missing(_originalDescriptionMeta);
    }
  ...
  ReceiptLine map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ReceiptLine(
      ...
      originalDescription: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}original_description'])!,
...
class ReceiptLine extends DataClass implements Insertable<ReceiptLine> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['original_description'] = Variable<String>(originalDescription);
  ...
  factory ReceiptLine.fromJson(Map<String, dynamic> json,
    ...
    return ReceiptLine(
      ...
      originalDescription:
          serializer.fromJson<String>(json['originalDescription']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'originalDescription': serializer.toJson<String>(originalDescription),
  ...
  ReceiptLine copyWithCompanion(ReceiptLinesCompanion data) {
    return ReceiptLine(
      ...
      originalDescription: data.originalDescription.present
          ? data.originalDescription.value
  ...
  String toString() {
    return (StringBuffer('ReceiptLine(')
          ...
          ..write('originalDescription: $originalDescription, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is ReceiptLine &&
          ...
          other.originalDescription == this.originalDescription &&
...
class ReceiptLinesCompanion extends UpdateCompanion<ReceiptLine> {
  ...
  final Value<String> originalDescription;
  ...
  const ReceiptLinesCompanion({
    ...
    this.originalDescription = const Value.absent(),
  ...
  static Insertable<ReceiptLine> custom({
    ...
    Expression<String>? originalDescription,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (originalDescription.present) {
      map['original_description'] = Variable<String>(originalDescription.value);
    }
...
class $ReceiptAiInsightRunsTable extends ReceiptAiInsightRuns
    with TableInfo<$ReceiptAiInsightRunsTable, ReceiptAiInsightRun> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ReceiptAiInsightRunsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
  ...
  late final GeneratedColumn<String> content = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: true);
  @override
  List<GeneratedColumn> get $columns => [id, listId, generatedAt, content];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'receipt_ai_insight_runs';
  @override
  VerificationContext validateIntegrity(
      Insertable<ReceiptAiInsightRun> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ReceiptAiInsightRun map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ReceiptAiInsightRun(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      listId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}list_id'])!,
  ...
  @override
  $ReceiptAiInsightRunsTable createAlias(String alias) {
    return $ReceiptAiInsightRunsTable(attachedDatabase, alias);
  }
}

class ReceiptAiInsightRun extends DataClass
    implements Insertable<ReceiptAiInsightRun> {
  final int id;
  final int listId;
  final DateTime generatedAt;
  final String content;
  const ReceiptAiInsightRun(
      {required this.id,
      required this.listId,
  ...
  ReceiptAiInsightRunsCompanion toCompanion(bool nullToAbsent) {
    return ReceiptAiInsightRunsCompanion(
      id: Value(id),
      listId: Value(listId),
  ...
  factory ReceiptAiInsightRun.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return ReceiptAiInsightRun(
      id: serializer.fromJson<int>(json['id']),
  ...
  ReceiptAiInsightRun copyWith(
          {int? id, int? listId, DateTime? generatedAt, String? content}) =>
      ReceiptAiInsightRun(
        id: id ?? this.id,
        listId: listId ?? this.listId,
  ...
  ReceiptAiInsightRun copyWithCompanion(ReceiptAiInsightRunsCompanion data) {
    return ReceiptAiInsightRun(
      id: data.id.present ? data.id.value : this.id,
      listId: data.listId.present ? data.listId.value : this.listId,
      generatedAt:
  ...
  @override
  String toString() {
    return (StringBuffer('ReceiptAiInsightRun(')
          ..write('id: $id, ')
          ..write('listId: $listId, ')
  ...
  @override
  int get hashCode => Object.hash(id, listId, generatedAt, content);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ReceiptAiInsightRun &&
          other.id == this.id &&
          other.listId == this.listId &&
...
class ReceiptAiInsightRunsCompanion
    extends UpdateCompanion<ReceiptAiInsightRun> {
  final Value<int> id;
  final Value<int> listId;
  final Value<DateTime> generatedAt;
  final Value<String> content;
  const ReceiptAiInsightRunsCompanion({
    this.id = const Value.absent(),
    this.listId = const Value.absent(),
  ...
  ReceiptAiInsightRunsCompanion.insert({
    ...
    required String content,
        ...
        generatedAt = Value(generatedAt),
        content = Value(content);
  static Insertable<ReceiptAiInsightRun> custom({
    Expression<int>? id,
    Expression<int>? listId,
  ...
  ReceiptAiInsightRunsCompanion copyWith(
      {Value<int>? id,
      Value<int>? listId,
  ...
  @override
  String toString() {
    return (StringBuffer('ReceiptAiInsightRunsCompanion(')
          ..write('id: $id, ')
          ..write('listId: $listId, ')
          ..write('generatedAt: $generatedAt, ')
          ..write('content: $content')
...
class $SyncOutboxTable extends SyncOutbox
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, globalId, entityType, operation, enqueuedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class SyncOutboxData extends DataClass implements Insertable<SyncOutboxData> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, globalId, entityType, operation, enqueuedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $SyncPendingOrphansTable extends SyncPendingOrphans
    with TableInfo<$SyncPendingOrphansTable, SyncPendingOrphan> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $SyncPendingOrphansTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
      ...
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('PRIMARY KEY AUTOINCREMENT'));
  static const VerificationMeta _entityJsonMeta =
      const VerificationMeta('entityJson');
  @override
  ...
  late final GeneratedColumn<DateTime> receivedAt = GeneratedColumn<DateTime>(
      ...
      type: DriftSqlType.dateTime, requiredDuringInsert: true);
  @override
  List<GeneratedColumn> get $columns => [id, entityJson, receivedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'sync_pending_orphans';
  @override
  VerificationContext validateIntegrity(Insertable<SyncPendingOrphan> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
    ...
    if (data.containsKey('entity_json')) {
      context.handle(
          _entityJsonMeta,
          entityJson.isAcceptableOrUnknown(
              data['entity_json']!, _entityJsonMeta));
    } else if (isInserting) {
      context.missing(_entityJsonMeta);
    }
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  SyncPendingOrphan map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return SyncPendingOrphan(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
  ...
  @override
  $SyncPendingOrphansTable createAlias(String alias) {
    return $SyncPendingOrphansTable(attachedDatabase, alias);
  }
}

class SyncPendingOrphan extends DataClass
    implements Insertable<SyncPendingOrphan> {
  final int id;
  final String entityJson;
  final DateTime receivedAt;
  const SyncPendingOrphan(
      {required this.id, required this.entityJson, required this.receivedAt});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
  ...
  SyncPendingOrphansCompanion toCompanion(bool nullToAbsent) {
    return SyncPendingOrphansCompanion(
      id: Value(id),
  ...
  factory SyncPendingOrphan.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return SyncPendingOrphan(
      id: serializer.fromJson<int>(json['id']),
  ...
  SyncPendingOrphan copyWith(
          {int? id, String? entityJson, DateTime? receivedAt}) =>
      SyncPendingOrphan(
        id: id ?? this.id,
        entityJson: entityJson ?? this.entityJson,
        receivedAt: receivedAt ?? this.receivedAt,
      );
  SyncPendingOrphan copyWithCompanion(SyncPendingOrphansCompanion data) {
    return SyncPendingOrphan(
      id: data.id.present ? data.id.value : this.id,
      entityJson:
  ...
  @override
  String toString() {
    return (StringBuffer('SyncPendingOrphan(')
          ..write('id: $id, ')
  ...
  @override
  int get hashCode => Object.hash(id, entityJson, receivedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is SyncPendingOrphan &&
          other.id == this.id &&
          other.entityJson == this.entityJson &&
          other.receivedAt == this.receivedAt);
}

class SyncPendingOrphansCompanion extends UpdateCompanion<SyncPendingOrphan> {
  final Value<int> id;
  final Value<String> entityJson;
  final Value<DateTime> receivedAt;
  const SyncPendingOrphansCompanion({
    this.id = const Value.absent(),
  ...
  SyncPendingOrphansCompanion.insert({
    ...
    required DateTime receivedAt,
        ...
        receivedAt = Value(receivedAt);
  static Insertable<SyncPendingOrphan> custom({
    Expression<int>? id,
  ...
  SyncPendingOrphansCompanion copyWith(
      {Value<int>? id,
  ...
  @override
  String toString() {
    return (StringBuffer('SyncPendingOrphansCompanion(')
          ..write('id: $id, ')
          ..write('entityJson: $entityJson, ')
          ..write('receivedAt: $receivedAt')
          ..write(')'))
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $ReceiptListsTable receiptLists = $ReceiptListsTable(this);
  ...
  late final $SyncPendingOrphansTable syncPendingOrphans =
      $SyncPendingOrphansTable(this);
  @override
...
class $$ShoppingListsTableFilterComposer
  ...
  ColumnFilters<String> get syncSpaceId => $composableBuilder(
      column: $table.syncSpaceId, builder: (column) => ColumnFilters(column));
...
class $$ShoppingListsTableOrderingComposer
  ...
  ColumnOrderings<String> get syncSpaceId => $composableBuilder(
      column: $table.syncSpaceId, builder: (column) => ColumnOrderings(column));
...
class $$ShoppingListsTableAnnotationComposer
  ...
  GeneratedColumn<String> get modifiedByDevice => $composableBuilder(
      column: $table.modifiedByDevice, builder: (column) => column);

  GeneratedColumn<bool> get syncEnabled => $composableBuilder(
      column: $table.syncEnabled, builder: (column) => column);

  GeneratedColumn<String> get syncSpaceId => $composableBuilder(
      column: $table.syncSpaceId, builder: (column) => column);
...
typedef $$TakeAwayOrderLinesTableProcessedTableManager = ProcessedTableManager<
    ...
    TakeAwayOrderLine,
    PrefetchHooks Function()>;
typedef $$ReceiptListsTableCreateCompanionBuilder = ReceiptListsCompanion
    Function({
  Value<int> id,
  required String name,
  required DateTime createdAt,
...
class $$ReceiptListsTableFilterComposer
    extends Composer<_$AppDatabase, $ReceiptListsTable> {
  $$ReceiptListsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ReceiptListsTableOrderingComposer
    extends Composer<_$AppDatabase, $ReceiptListsTable> {
  $$ReceiptListsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ReceiptListsTableAnnotationComposer
    extends Composer<_$AppDatabase, $ReceiptListsTable> {
  $$ReceiptListsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ReceiptListsTableTableManager extends RootTableManager<
    ...
    $$ReceiptListsTableOrderingComposer,
    $$ReceiptListsTableAnnotationComposer,
    $$ReceiptListsTableCreateCompanionBuilder,
    $$ReceiptListsTableUpdateCompanionBuilder,
    (
      ReceiptList,
      BaseReferences<_$AppDatabase, $ReceiptListsTable, ReceiptList>
    ),
    ReceiptList,
    PrefetchHooks Function()> {
  $$ReceiptListsTableTableManager(_$AppDatabase db, $ReceiptListsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$ReceiptListsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$ReceiptListsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$ReceiptListsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<int> id = const Value.absent(),
            Value<String> name = const Value.absent(),
            Value<DateTime> createdAt = const Value.absent(),
...
typedef $$ReceiptListsTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $ReceiptListsTable,
    ReceiptList,
    $$ReceiptListsTableFilterComposer,
...
class $$ReceiptsTableFilterComposer
  ...
  ColumnFilters<String> get pdfFileName => $composableBuilder(
      column: $table.pdfFileName, builder: (column) => ColumnFilters(column));
...
class $$ReceiptsTableOrderingComposer
  ...
  ColumnOrderings<String> get pdfFileName => $composableBuilder(
      column: $table.pdfFileName, builder: (column) => ColumnOrderings(column));
...
class $$ReceiptsTableAnnotationComposer
  ...
  GeneratedColumn<String> get pdfFileName => $composableBuilder(
      column: $table.pdfFileName, builder: (column) => column);
...
typedef $$ReceiptsTableProcessedTableManager = ProcessedTableManager<
    ...
    Receipt,
    PrefetchHooks Function()>;
typedef $$ReceiptLinesTableCreateCompanionBuilder = ReceiptLinesCompanion
    Function({
  Value<int> id,
  required int receiptId,
  required String originalDescription,
...
typedef $$ReceiptLinesTableUpdateCompanionBuilder = ReceiptLinesCompanion
    Function({
  Value<int> id,
  Value<int> receiptId,
  Value<String> originalDescription,
...
class $$ReceiptLinesTableFilterComposer
  ...
  ColumnFilters<String> get originalDescription => $composableBuilder(
      column: $table.originalDescription,
      builder: (column) => ColumnFilters(column));
...
class $$ReceiptLinesTableOrderingComposer
  ...
  ColumnOrderings<String> get originalDescription => $composableBuilder(
      column: $table.originalDescription,
      builder: (column) => ColumnOrderings(column));
...
class $$ReceiptLinesTableAnnotationComposer
  ...
  GeneratedColumn<String> get originalDescription => $composableBuilder(
      column: $table.originalDescription, builder: (column) => column);
...
class $$ReceiptLinesTableTableManager extends RootTableManager<
    _$AppDatabase,
    $ReceiptLinesTable,
    ReceiptLine,
    $$ReceiptLinesTableFilterComposer,
  ...
  $$ReceiptLinesTableTableManager(_$AppDatabase db, $ReceiptLinesTable table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<String> originalDescription = const Value.absent(),
...
typedef $$ReceiptLinesTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $ReceiptLinesTable,
    ReceiptLine,
    $$ReceiptLinesTableFilterComposer,
    ...
    ReceiptLine,
    PrefetchHooks Function()>;
typedef $$ReceiptAiInsightRunsTableCreateCompanionBuilder
    = ReceiptAiInsightRunsCompanion Function({
  Value<int> id,
  required int listId,
  required DateTime generatedAt,
  required String content,
});
typedef $$ReceiptAiInsightRunsTableUpdateCompanionBuilder
    = ReceiptAiInsightRunsCompanion Function({
  Value<int> id,
  Value<int> listId,
  Value<DateTime> generatedAt,
...
class $$ReceiptAiInsightRunsTableFilterComposer
    extends Composer<_$AppDatabase, $ReceiptAiInsightRunsTable> {
  $$ReceiptAiInsightRunsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ReceiptAiInsightRunsTableOrderingComposer
    extends Composer<_$AppDatabase, $ReceiptAiInsightRunsTable> {
  $$ReceiptAiInsightRunsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ReceiptAiInsightRunsTableAnnotationComposer
    extends Composer<_$AppDatabase, $ReceiptAiInsightRunsTable> {
  $$ReceiptAiInsightRunsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ReceiptAiInsightRunsTableTableManager extends RootTableManager<
    _$AppDatabase,
    $ReceiptAiInsightRunsTable,
    ReceiptAiInsightRun,
    $$ReceiptAiInsightRunsTableFilterComposer,
    $$ReceiptAiInsightRunsTableOrderingComposer,
    $$ReceiptAiInsightRunsTableAnnotationComposer,
    $$ReceiptAiInsightRunsTableCreateCompanionBuilder,
    $$ReceiptAiInsightRunsTableUpdateCompanionBuilder,
    (
      ReceiptAiInsightRun,
      BaseReferences<_$AppDatabase, $ReceiptAiInsightRunsTable,
          ReceiptAiInsightRun>
    ),
    ReceiptAiInsightRun,
    PrefetchHooks Function()> {
  $$ReceiptAiInsightRunsTableTableManager(
      _$AppDatabase db, $ReceiptAiInsightRunsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$ReceiptAiInsightRunsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$ReceiptAiInsightRunsTableOrderingComposer(
                  $db: db, $table: table),
          createComputedFieldComposer: () =>
...
typedef $$ReceiptAiInsightRunsTableProcessedTableManager
    = ProcessedTableManager<
        _$AppDatabase,
        $ReceiptAiInsightRunsTable,
        ReceiptAiInsightRun,
...
typedef $$SyncMetadataTableProcessedTableManager = ProcessedTableManager<
    ...
    SyncMetadataData,
    PrefetchHooks Function()>;
typedef $$SyncPendingOrphansTableCreateCompanionBuilder
    = SyncPendingOrphansCompanion Function({
  Value<int> id,
  required String entityJson,
  required DateTime receivedAt,
});
typedef $$SyncPendingOrphansTableUpdateCompanionBuilder
    = SyncPendingOrphansCompanion Function({
  Value<int> id,
  Value<String> entityJson,
  Value<DateTime> receivedAt,
...
class $$SyncPendingOrphansTableFilterComposer
    extends Composer<_$AppDatabase, $SyncPendingOrphansTable> {
  $$SyncPendingOrphansTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnFilters<String> get entityJson => $composableBuilder(
      column: $table.entityJson, builder: (column) => ColumnFilters(column));

  ColumnFilters<DateTime> get receivedAt => $composableBuilder(
      column: $table.receivedAt, builder: (column) => ColumnFilters(column));
}

class $$SyncPendingOrphansTableOrderingComposer
    extends Composer<_$AppDatabase, $SyncPendingOrphansTable> {
  $$SyncPendingOrphansTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<String> get entityJson => $composableBuilder(
      column: $table.entityJson, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<DateTime> get receivedAt => $composableBuilder(
      column: $table.receivedAt, builder: (column) => ColumnOrderings(column));
}

class $$SyncPendingOrphansTableAnnotationComposer
    extends Composer<_$AppDatabase, $SyncPendingOrphansTable> {
  $$SyncPendingOrphansTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<String> get entityJson => $composableBuilder(
...
class $$SyncPendingOrphansTableTableManager extends RootTableManager<
    _$AppDatabase,
    $SyncPendingOrphansTable,
    SyncPendingOrphan,
    $$SyncPendingOrphansTableFilterComposer,
    $$SyncPendingOrphansTableOrderingComposer,
    $$SyncPendingOrphansTableAnnotationComposer,
    $$SyncPendingOrphansTableCreateCompanionBuilder,
    $$SyncPendingOrphansTableUpdateCompanionBuilder,
    (
      SyncPendingOrphan,
      BaseReferences<_$AppDatabase, $SyncPendingOrphansTable, SyncPendingOrphan>
    ),
    SyncPendingOrphan,
    PrefetchHooks Function()> {
  $$SyncPendingOrphansTableTableManager(
      _$AppDatabase db, $SyncPendingOrphansTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$SyncPendingOrphansTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$SyncPendingOrphansTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$SyncPendingOrphansTableAnnotationComposer(
                  $db: db, $table: table),
          updateCompanionCallback: ({
            Value<int> id = const Value.absent(),
            Value<String> entityJson = const Value.absent(),
            Value<DateTime> receivedAt = const Value.absent(),
          }) =>
              SyncPendingOrphansCompanion(
            id: id,
...
typedef $$SyncPendingOrphansTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $SyncPendingOrphansTable,
    SyncPendingOrphan,
    $$SyncPendingOrphansTableFilterComposer,
...
class $AppDatabaseManager {
  ...
  $$ReceiptListsTableTableManager get receiptLists =>
      $$ReceiptListsTableTableManager(_db, _db.receiptLists);
  ...
  $$SyncPendingOrphansTableTableManager get syncPendingOrphans =>
      $$SyncPendingOrphansTableTableManager(_db, _db.syncPendingOrphans);
}
